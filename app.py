...
class App(ctk.CTk):
    ...
    def _build_ui(self):
        ...
        self._url_entry = ctk.CTkTextbox(url_row, height=60, font=ctk.CTkFont(size=13),
        ...
        ctk.CTkEntry(dir_row, textvariable=self._out_var,
                     font=ctk.CTkFont(size=13),
    ...
    def _clear_placeholder(self, _event=None):
        text = self._url_entry.get("0.0", "end").strip()
        if text == "Paste one or more URLs here, one per line…":
    ...
    def _add_item_row(self, item: DownloadItem):
        ...
        meta.pack(fill="x")
        item.speed_label = ctk.CTkLabel(meta, text="",
    ...
    def _download(self, item: DownloadItem):
        ...
        # Apply quality filter for video
    ...
    # ──────────────────────────────────────────
    #  UI Updates (safe from any thread)
    # ──────────────────────────────────────────
...
if __name__ == "__main__":
    ...
    try:
        ...
        messagebox.showwarning(
            ...
            "The app will still launch but format conversion may fail."
        )
        root.destroy()
